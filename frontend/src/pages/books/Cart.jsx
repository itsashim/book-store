...
function Cart() {
    ...
    const totalPrice = useSelector((state)=> state.cart.cartItems.reduce((acc,item)=> acc + item.newPrice ,0))
                    ...
                    {cartItems.length > 0 ?
                        <ul role="list" className="-my-6 divide-y divide-gray-200">
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                                ...
                                <div className="flex">
                                    <button  onClick={()=>removeItem(item)} type="button" className="font-medium text-indigo-600 hover:text-indigo-500">
                                    Remove
                                    </button>
                                </div>
                                </div>
